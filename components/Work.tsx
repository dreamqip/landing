    ...
    <section className="pb-20">
      ...
      <div className="flex flex-row gap-y-8 justify-center text-white gap-x-16">
        <div className="flex text-center justify-center items-center max-w-[440px]">
          <p>
            Equip your NFT bike and trip, and get an award from $SCRW fungible tokens. Then, wait for the energy
            recovery, energy soul-bound fungible token, and go again on the road. During the trip, you can see the
            speed, the mileage that was driven on the bike, the number of tokens earned, etc. Then, while waiting for
            power to be restored, you can admire your bikes or count the number of zeros in the token balance.
          </p>
        </div>
